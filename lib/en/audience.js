...
exports.analyzeAudienceSuitability = analyzeAudienceSuitability;
exports.checkAudienceFlags = checkAudienceFlags;
exports.getAudienceSuitabilitySummary = getAudienceSuitabilitySummary;
exports.getAudienceRecommendations = getAudienceRecommendations;

/**
 * Analyze text for audience suitability issues
 */
function analyzeAudienceSuitability(text) {
 ...
 */
function checkAudienceFlags(suitability) {
    return {
 ...
 */
function detectPassiveOverload(text, sentenceCount) {
    if (sentenceCount === 0)
        return false;
 ...
 */
function detectArchaicTerms(text) {
    const archaicTerms = [
 ...
 */
function detectClicheMetaphors(text) {
 ...
 */
function detectAcademicJargon(text) {
 ...
 */
function getAudienceSuitabilitySummary(suitability) {
 ...
 */
function getAudienceRecommendations(suitability) {
